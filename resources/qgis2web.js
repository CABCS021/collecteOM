...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [533768.407853, 5942074.577102, 544232.273680, 5950519.588161], maxZoom: 17, minZoom: 11
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([533768.407853, 5942074.577102, 544232.273680, 5950519.588161], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Jours de collecte des ordures ménagères et tri à Beaune</h2>';
        return titleElement;
    })(),
